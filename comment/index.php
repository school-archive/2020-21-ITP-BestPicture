...
<body>
    <header>
        <div class="wrapper">
            ...
            <nav>
                <a href="../index.php">Home</a> <a href="#">Anmelden</a> <a href="../upload/upload.php">Upload</a> <a href="../profil/index.php"> <img class="user" src="../assets/images/user.png" alt="user"> </a>
            </nav>
